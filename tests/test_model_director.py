...
class TestDirector(unittest.TestCase):
    ...
    def test_create(self) -> None:
        ...
        r2 = self.session.query(Director).filter_by(person_id=p1.id).first()
        ...
        r3 = self.session.query(Director).filter_by(movie_id=m1.id).first()
